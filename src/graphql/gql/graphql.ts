...
export type JobModel = {
  ...
  status: JobStatus;
  transcriptionText: Scalars['String']['output'];
...
export type GetAllJobsQuery = { __typename?: 'Query', getJobs: Array<{ __typename?: 'JobModel', id: string, status: JobStatus, filename: string, updatedAt: any }> };
